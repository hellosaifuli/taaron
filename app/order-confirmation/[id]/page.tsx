        ...
        <FadeInSection from="up" className="mb-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs uppercase tracking-widest text-[#9E9690]">
                {order.order_number}
              </p>
            </div>
          </div>
          <p className="mt-5 text-sm leading-relaxed text-[#5C5652]">
            Thank you,{" "}
            <strong className="text-[#111111]">{order.customer_name}</strong>.
        ...
        {order.status !== "delivered" && order.status !== "cancelled" && (
          <FadeInSection delay={100} from="up">
            <div className="mb-6 flex items-center gap-4 bg-[#FEF9EE] px-6 py-4">
              <svg
                className="h-5 w-5 flex-shrink-0 text-[#9B6F47]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
              ...
              <div>
                <p className="text-[10px] uppercase tracking-widest text-[#9B6F47]">
                  Estimated Delivery
                </p>
                ...
                <p className="text-xs text-[#9E9690]">
                  {isDhaka
                    ? "Within Dhaka: 1–2 business days"
              ...
              {statusSteps.map((step, idx) => (
                <div key={step} className="flex flex-1 items-center">
                  ...
                  {idx < statusSteps.length - 1 && (
                    <div
                      className={`mb-4 flex-1 border-t ${idx < currentStepIndex ? "border-[#9B6F47]" : "border-[#E5DFD6]"}`}
                    />
                  )}
                </div>
              ))}
        ...
        <FadeInSection delay={220} from="up">
          <div className="mb-6 grid gap-4 sm:grid-cols-2">
            <div className="bg-white p-6">
              <p className="mb-4 text-[10px] uppercase tracking-[0.4em] text-[#9E9690]">
                Shipping To
              </p>
