...
export const metadata: Metadata = {
  ...
  description:
    "30-day hassle-free returns and exchanges on all Taaron leather goods. Unused condition required. Full refund via bKash or bank transfer.",
  alternates: { canonical: `${baseUrl}/returns` },
  openGraph: {
    title: "Returns & Exchanges",
    description:
      "30-day hassle-free returns. Full refund via bKash or bank transfer within 3–5 business days after inspection.",
    url: `${baseUrl}/returns`,
    siteName: "Taaron",
    images: [
      {
  ...
  return (
    <div className="min-h-screen bg-[#F7F4EF] text-[#111111]">
      ...
      >
        ...
        <div className="relative mx-auto max-w-screen-xl w-full">
          ...
          <p className="mt-3 max-w-md text-sm leading-relaxed text-[#5C5652]">
            Not quite right? No problem. We accept returns within 30 days of
            delivery — no fuss, no questions.
          </p>
        </div>
      </div>
      ...
      <section className="mx-auto max-w-screen-xl px-6 py-16 lg:px-16 lg:py-20">
        <FadeInSection>
          <p className="mb-12 text-[10px] uppercase tracking-[0.4em] text-[#9E9690]">
            How it works
          </p>
        </FadeInSection>
          ...
          {steps.map((step, idx) => (
            <FadeInSection key={step.n} delay={idx * 80}>
              <div className="group border-t border-[#E5DFD6] pt-6">
                ...
                <h3 className="mt-4 text-[11px] font-semibold uppercase tracking-widest text-[#111111]">
                  {step.title}
                </h3>
                <p className="mt-3 text-sm leading-loose text-[#5C5652]">
                  {step.body}
                </p>
              </div>
            </FadeInSection>
          ...
          <FadeInSection>
            ...
            <div className="divide-y divide-[#E5DFD6]">
              <div className="py-6 first:pt-0">
                ...
                <p
                  className="mt-2 text-2xl font-medium text-[#111111]"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  30 Days
                </p>
              ...
              <div className="py-6">
                ...
                <a
                  ...
                  className="mt-2 block text-sm font-medium text-[#9B6F47] transition-colors hover:text-[#111111]"
                >
            ...
            <dl className="divide-y divide-[#E5DFD6]">
              {faqs.map((faq) => (
                <div key={faq.q} className="group py-5">
                  ...
                  <dd className="mt-2 text-sm leading-relaxed text-[#5C5652]">
                    {faq.a}
                  </dd>
                </div>
              ))}
