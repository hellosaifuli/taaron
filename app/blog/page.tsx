...
export const metadata: Metadata = {
  title: "Journal",
  description:
    "Leather care guides, style advice, and stories from Taaron — premium leather goods from Bangladesh.",
  alternates: { canonical: `${baseUrl}/blog` },
  openGraph: {
    title: "Journal — Taaron",
    description:
      "Leather care guides, buying advice, and brand stories from Taaron.",
    url: `${baseUrl}/blog`,
    siteName: "Taaron",
    images: [
      {
    ...
    <div className="min-h-screen bg-[#F7F4EF] text-[#111111]">
        ...
        <div className="relative mx-auto w-full max-w-screen-xl">
          <FadeInSection from="up">
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-[#5C5652]">
              Leather care guides, buying advice, and stories about craft — from
      ...
      <div className="mx-auto max-w-screen-xl px-6 py-16 lg:px-16 lg:py-20">
          ...
          <Link href={`/blog/${featured.slug}`} className="group mb-16 block">
            <div className="grid gap-0 lg:grid-cols-[1.4fr_1fr]">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #2C1F14 0%, #5C3D22 40%, #9B6F47 100%)",
                }}
              >
                <div>
                  <span
                    className={`inline-block px-3 py-1 text-[9px] uppercase tracking-widest ${CATEGORY_COLORS[featured.category] ?? "bg-[#EDE9E3] text-[#5C5652]"}`}
                  >
                    {featured.category}
                  </span>
                  <h2
        ...
        <div className="border-t border-[#E5DFD6] pt-16">
          <FadeInSection from="up">
            <p className="mb-10 text-[10px] uppercase tracking-[0.4em] text-[#9E9690]">
              All Articles
            </p>
          </FadeInSection>
          <div className="columns-1 gap-4 sm:columns-2 lg:columns-3">
            {rest.map((post, i) => (
              ...
              >
                <Link
                  href={`/blog/${post.slug}`}
                  className="group flex flex-col p-8 transition-all duration-300 hover:bg-white hover:shadow-sm"
                >
                  <span
                    className={`self-start px-2.5 py-1 text-[9px] uppercase tracking-widest ${CATEGORY_COLORS[post.category] ?? "bg-[#EDE9E3] text-[#5C5652]"}`}
                  >
                    {post.category}
                  </span>
                  <h2
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-[#5C5652]">
                    {post.excerpt}
                  </p>
