...
const categoryMeta: Record<string, { name: string; description: string }> = {
  all: {
    name: "All Products",
    description:
      "The complete Taaron collection — premium leather goods crafted for everyday elegance.",
  },
  bags: {
    name: "Bags & Backpacks",
    description:
      "Full-grain leather bags built for the modern professional. Structure, substance, style.",
  },
  wallets: {
    name: "Wallets",
    description:
      "Slim, refined, built to last. Wallets that get better with every day of use.",
  },
  belts: {
    name: "Belts",
    description:
      "Precision-cut leather belts with solid brass hardware. The finishing detail.",
  },
  cardholder: {
    name: "Card Holders",
    description:
      "Minimalist card carriers for the essentials. Compact, clean, effortless.",
  },
  ladies: {
    name: "Ladies Bags",
    description:
      "Elegant leather bags designed with a feminine sensibility. Timeless, not trendy.",
  },
};
    ...
    <div className="min-h-screen bg-[#F7F4EF] text-[#111111]">
      ...
      {displayProducts.length > 0 ? (
        ...
        <div className="py-32 text-center">
          <p className="text-sm text-[#9E9690]">
